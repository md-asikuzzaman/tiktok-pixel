...
__export(index_exports, {
  TikTokPixelNext: () => TikTokPixelNext,
  page: () => page,
  track: () => track,
...
function PixelLogic({ id, debug }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_script.default, { id: "tiktok-pixel-next", strategy: "afterInteractive", children: createTikTokSnippet(id, debug) });
}
function TikTokPixelNext(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: null, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PixelLogic, { ...props }) });
}
